...
b8 _hf_win_create_window(hf_window* w){
...
b8 _hf_win_destroy_window(hf_window* w){
...
b8 _hf_win_should_window_update(hf_window* w){
...
void _hf_win_update_window(hf_window* w){
    SwapBuffers(w->hdc);
